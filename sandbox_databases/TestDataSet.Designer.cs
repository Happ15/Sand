...
namespace sandbox_databases.TestDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `test`.`users` WHERE ((`id` = @p1) AND (`login` = @p2) AND (`password" +
                "` = @p3) AND (`name` = @p4) AND (`surname` = @p5))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `test`.`users` (`login`, `password`, `name`, `surname`) VALUES (@p1, " +
                "@p2, @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `test`.`users` SET `login` = @p1, `password` = @p2, `name` = @p3, `surname" +
                "` = @p4 WHERE ((`id` = @p5) AND (`login` = @p6) AND (`password` = @p7) AND (`nam" +
                "e` = @p8) AND (`surname` = @p9))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::sandbox_databases.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `login`, `password`, `name`, `surname` FROM `test`.`users`";
